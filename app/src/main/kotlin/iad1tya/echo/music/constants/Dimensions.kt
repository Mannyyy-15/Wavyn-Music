...
val FloatingCompactMaxWidth = 420.dp
const val FloatingCompactWidthFraction = 0.86f
val DynamicIslandMaxWidth = 370.dp
const val DynamicIslandWidthFraction = 0.76f
