...
import iad1tya.echo.music.constants.ListenTogetherAutoApproveSuggestionsKey
...
class ListenTogetherClient
    ...
    constructor(
        ...
        private fun ensureNotificationChannel() {
            try {
                ...
                if (existing == null) {
                    ...
                    channel.description = "Join requests and room suggestions"
        ...
        private fun showJoinRequestNotification(payload: JoinRequestPayload) {
            ...
            val content = "${payload.username} wants to join your room"

            val builder =
                NotificationCompat
                    .Builder(context, NOTIFICATION_CHANNEL_ID)
                    .setSmallIcon(R.drawable.group_outlined)
                    .setContentTitle("Listen Together")
        ...
        private fun showSuggestionNotification(payload: SuggestionReceivedPayload) {
            ...
            val content = "${payload.fromUsername} suggested: ${payload.trackInfo.title}"
