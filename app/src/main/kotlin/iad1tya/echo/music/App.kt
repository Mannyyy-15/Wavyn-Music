...
import iad1tya.echo.music.canvas.WavynCanvas
...
class App : Application(), SingletonImageLoader.Factory {
    ...
    override fun onCreate() {
        ...
        WavynCanvas.initialize(BuildConfig.CANVAS_BEARER_TOKEN)
        ...
        // ØªÙ‡ÙŠØ¦Ø© Ø¥Ø¹Ø¯Ø§Ø¯Ø§Øª Ø§Ù„ØªØ·Ø¨ÙŠÙ‚ Ø¹Ù†Ø¯ Ø§Ù„Ø¥Ù‚Ù„Ø§Ø¹
    ...
    private suspend fun initializeSettings() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            ...
            // Music playback channel â€” must be created before MusicService posts its first
