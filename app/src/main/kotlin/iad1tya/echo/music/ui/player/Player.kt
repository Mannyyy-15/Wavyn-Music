                        ...
                        AnimatedContent(
                            ...
                            if (showLyrics) {
                                ...
                                Thumbnail(
                                    ...
                                    dominantColor = gradientColors.getOrElse(0) { MaterialTheme.colorScheme.onSurface },
                                    secondaryColor = gradientColors.getOrElse(1) { MaterialTheme.colorScheme.secondary },
                                    tertiaryColor = gradientColors.getOrElse(2) { MaterialTheme.colorScheme.tertiary },
                    ...
                    verticalArrangement = Arrangement.spacedBy(16.dp)
                        ...
                        if (hasWiredHeadset) {
                            ...
                            Row(
                                ...
                                Icon(
                                    painter = painterResource(R.drawable.ic_audio_earphone),
                                    contentDescription = null,
                                    modifier = Modifier.size(28.dp),
                        ...
                        if (hasBluetoothDevice) {
                            ...
                            Row(
                                ...
                                Icon(
                                    painter = painterResource(R.drawable.ic_audio_bluetooth),
                                    contentDescription = null,
                                    modifier = Modifier.size(28.dp),
                        ...
                        if (hasConnectedDevice) {
                            ...
                            connectedWifiRoutes.forEach { route ->
                                Row(
                                    ...
                                    Icon(
                                        painter = painterResource(R.drawable.ic_audio_wifi),
                                        contentDescription = null,
                                        modifier = Modifier.size(28.dp),
                                        tint = MaterialTheme.colorScheme.primary
                                    )
                            ...
                            if (availableWifiRoutes.isNotEmpty()) {
                                ...
                                availableWifiRoutes.forEach { route ->
                                    ...
                                    Row(
                                        ...
                                        Icon(
                                            painter = painterResource(
                                                if (isCastDevice) R.drawable.wifi_proxy else R.drawable.ic_audio_wifi
                                            ),
                                            contentDescription = null,
                                            modifier = Modifier.size(28.dp),
