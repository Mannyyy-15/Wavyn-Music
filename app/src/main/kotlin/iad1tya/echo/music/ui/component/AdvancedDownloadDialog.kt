...
fun AdvancedDownloadDialog(
    ...
    var defaultDownloadPath by remember { mutableStateOf("Downloads/WavynMusic") }
...
fun downloadFile(context: Context, url: String, fileName: String, destinationUri: Uri?) {
    ...
    try {
        ...
        if (destinationUri != null) {
              ...
              // For now, let's use the standard "Downloads/WavynMusic" SubPath approach which works well.
              ...
              // but create a subfolder.
               ...
               request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, "WavynMusic/$fileName")
               Toast.makeText(context, "Downloading to Downloads/WavynMusic", Toast.LENGTH_SHORT).show()
