                ...
                Column(
                    ...
                    if (showGuide) {
                        Column(
                            ...
                            Text(
                                text = "Destination must be YouTube Music for Wavyn Music compatibility.",
                            ...
                            Text(
                                text = "Done! Your playlists from Spotify, Apple Music, and other platforms are now available in Wavyn Music.",
                                style = MaterialTheme.typography.bodySmall,
                                fontWeight = FontWeight.SemiBold,
                            )
                        }
                ...
                Button(
                    onClick = {
                        scope.launch {
                            isImporting = true
                            importProgress = 0
                            statusText = "Importing to Wavyn Music..."
...
private val spotifyStepByStep = listOf(
    ...
    "Use the same YouTube Music account that you use in Wavyn Music.",
    "Select playlists/albums and review before transfer.",
    "Start transfer and wait for completion.",
    "Open Wavyn Music and your transferred playlists should appear.",
)
