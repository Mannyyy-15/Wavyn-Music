...
fun PlayerSettings(
    ...
    val (premiumVisualizer, onPremiumVisualizerChange) = rememberPreference(
        PremiumVisualizerKey,
        defaultValue = true
    )
    ...
    Column(
        ...
        PreferenceEntry(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.GraphicEq), null) },
            trailingContent = {
                Icon(
                    painter = rememberVectorPainter(if (showPlayerAudioSection) Icons.Rounded.ExpandLess else Icons.Rounded.ExpandMore),
        ...
        SliderPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.History), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.FastForward), null) },
            checked = skipSilence,
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Speed), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Equalizer), null) },
        ...
        if (crossfadeEnabled) {
            SliderPreference(
                ...
                icon = { Icon(rememberVectorPainter(Icons.Rounded.Timer), null) },
            ...
            SwitchPreference(
                ...
                icon = { Icon(rememberVectorPainter(Icons.Rounded.Album), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Bluetooth), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.BrightnessHigh), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Shuffle), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Block), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Repeat), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Download), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Storage), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Restore), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.SkipNext), null) },
        ...
        PreferenceEntry(
            ...
            trailingContent = {
                Icon(
                    painter = rememberVectorPainter(if (showMiscControlsSection) Icons.Rounded.ExpandLess else Icons.Rounded.ExpandMore),
                    contentDescription = null
                )
            },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Lyrics), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Favorite), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Swipe), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Notifications), null) },
        ...
        SwitchPreference(
            title = { Text("Premium dynamic artwork") },
            description = "Animated spiky goth artwork with real-time audio reaction",
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Palette), null) },
            checked = premiumVisualizer,
            onCheckedChange = onPremiumVisualizerChange
        )

        SwitchPreference(
            title = { Text(stringResource(R.string.stop_music_on_task_clear)) },
            icon = { Icon(rememberVectorPainter(Icons.Rounded.ClearAll), null) },
        ...
        SwitchPreference(
            ...
            icon = { Icon(rememberVectorPainter(Icons.Rounded.Close), null) },
