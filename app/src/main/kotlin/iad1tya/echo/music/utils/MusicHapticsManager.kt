...
class MusicHapticsManager @Inject constructor(
    ...
    // Expose real-time amplitude for UI visualizers
                ...
                setDataCaptureListener(
                    object : Visualizer.OnDataCaptureListener {
                        override fun onWaveFormDataCapture(
                            ...
                            // Max theoretical RMS ≈ 128; normalise to 0..1 with a boost for visibility
                            val normalised = (rms / 128f * 1.8f).coerceIn(0f, 1f)
