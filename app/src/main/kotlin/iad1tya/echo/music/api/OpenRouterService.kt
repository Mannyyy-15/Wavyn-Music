...
- NO special characters like Ä, Ä«, Å«, Ã±, Ã§, etc.
...
- Sanskrit/Hindi "à¤†" â†’ "aa" (not "Ä")
- Japanese "æ±äº¬" â†’ "toukyou" or "tokyo" (not "tÅkyÅ")
- Korean "ì„œìš¸" â†’ "seoul" (not "sÅul")
...
Examples:
- Japanese "ã“ã‚“ã«ã¡ã¯" to Hindi â†’ "à¤•à¥‹à¤¨à¥à¤¨à¤¿à¤šà¤¿à¤µà¤¾" (phonetic, not translation)
- English "Hello" to Hindi â†’ "à¤¹à¥‡à¤²à¥‹" (phonetic)
- Korean "ì•ˆë…•í•˜ì„¸ìš”" to Hindi â†’ "à¤…à¤¨à¥à¤¨à¥à¤¯à¥‹à¤‚à¤— à¤¹à¤¾à¤¸à¥‡à¤¯à¥‹" (phonetic)
