<div align="center">
  <img src="assets/Wavyn-new.png" alt="Wavyn Music Logo" width="140"/>
...
<a href="https://trendshift.io/repositories/20485" target="_blank"><img src="https://trendshift.io/api/badge/repositories/20485" alt="WavynMusicApp%2FWavyn-Music | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

<br>

  <a href="https://Wavynmusic.fun/download">
    <img src="assets/download.png" alt="Download" width="200"/>
  </a>
  &nbsp;
  <a href="https://Wavynmusic.fun/obtainium">
...
Wavyn Music delivers a seamless, premium listening experience by leveraging YouTube Music's vast library — without the ads. It adds powerful extras including offline downloads, real-time synchronized lyrics, and environment-aware music recognition.
...
### Discovery & Wavyn Find
- **Wavyn Find** — Identify songs playing around you using advanced audio recognition.
...
### Android
Download the latest APK from the [Releases Page](https://github.com/iad1tya/Wavyn-Music/releases/latest).

### Build from Source

1. **Clone the repository**
   ```bash
   git clone https://github.com/iad1tya/Wavyn-Music.git
   cd Wavyn-Music
   ```
...
<div align="center">
  ...
  &nbsp;
  <a href="https://t.me/WavynMusicApp"><img src="assets/telegram.png" width="130"/></a>
</div>
...
If Wavyn Music has been useful to you, consider supporting its development.
...
Wavyn Music stands on the shoulders of several excellent open-source projects. Sincere thanks to:
...
| [Music Recognizer](https://github.com/aleksey-saenko/MusicRecognizer) | Audio recognition (Wavyn Find) |

---

## Star History

[![Star History Chart](https://api.star-history.com/svg?repos=WavynMusicApp/Wavyn-Music&type=timeline&legend=top-left)](https://www.star-history.com/#WavynMusicApp/Wavyn-Music&type=timeline&legend=top-left)
