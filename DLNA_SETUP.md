...
Wavyn Music now supports streaming to DLNA/UPnP compatible devices on your local network!

## What is DLNA/UPnP?

DLNA (Digital Living Network Alliance) and UPnP (Universal Plug and Play) are protocols that allow devices on your network to discover and stream media to each other. This means you can play music from Wavyn Music on:
...
3. **Permissions**: Wavyn Music needs WiFi and network permissions (granted automatically)
...
DLNA device discovery starts automatically when you open Wavyn Music. The app will search for compatible devices on your network.
...
1. **Restart App**: Close and reopen Wavyn Music
...
Wavyn Music will automatically transcode if needed for compatibility.
...
Both protocols are supported in Wavyn Music, giving you maximum flexibility!
